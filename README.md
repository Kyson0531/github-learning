...
> **Experiment (feature/glass-hero)**: Codrops / Olivier Larose-inspired refractive glass Hero using drei MeshTransmissionMaterial, city Environment, pointer parallax, and reduced-motion / off-screen frameloop guards.
...
- **Three.js** + **React Three Fiber** + **Drei** — hero refractive glass torus (MeshTransmissionMaterial)
- Accessibility: `prefers-reduced-motion` disables canvas + smooth scroll; canvas pauses when off-screen; DPR capped

## Information architecture

1. **Hero** — name, bilingual title, R3F refractive glass + WebGL text behind
